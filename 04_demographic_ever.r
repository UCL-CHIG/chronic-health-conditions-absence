...
gias <- fread("3_DESCRIPTIVE_STUDY/schools_data/DR200604.02B_public_data_gias_data_25102021_20220614.csv")
...
save(demographics_ever, file = "3_DESCRIPTIVE_STUDY/processed/demographics_ever.rda")
