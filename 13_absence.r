...
absence[inception_year == 2013, year := AcademicYear - 2006]
absence[inception_year == 2014, year := AcademicYear - 2007]
absence[inception_year == 2015, year := AcademicYear - 2008]
...
absence[, inception_year := NULL]
absence[, AcademicYear := NULL]

save(absence, file = "3_DESCRIPTIVE_STUDY/processed/absence.rda")
rm(list = ls()); gc()
